...
2. [Click here to install](https://raw.githubusercontent.com/MrFrank2716/Herosaver/master/herosaver-autoloader.user.js "Click to install"), Link to repository: [herosaver-autoloader.user.js](herosaver-autoloader.user.js)
